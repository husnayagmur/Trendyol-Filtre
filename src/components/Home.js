            ...
            <div className="bg-white mx-auto max-w-screen-xl text-dark-black">
                <ul className="flex space-x-6 text-sm font-semibold font-montserrat overflow-hidden">
                    ...
                    >
                        ...
                        {/* Açılır Menü */}
                        {isCategoriesHovered && (
                            <div className="absolute top-full left-0 w-48 bg-white shadow-md mt-2 p-4 rounded-md">
                                <Link href="#" className="block text-sm font-semibold text-gray-800 py-2 hover:text-orange">Kadın</Link>
                                <Link href="#" className="block text-sm font-semibold text-gray-800 py-2 hover:text-orange">Erkek</Link>
                            </div>
                        )}
                    </li>
